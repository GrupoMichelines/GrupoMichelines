...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center border-b sticky top-0 z-50 bg-white">
      ...
      <main className="flex-1">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2 mt-12">
              <div className="flex flex-col space-y-4">
                ...
                <p className="text-gray-700">
                  Fundada a mais de 45 anos, tenos muita experiência no setor de táxis, o Grupo Michelines nasceu com a
                  missão de facilitar o acesso de novos motoristas a esta nobre profissão, oferecendo veículos de
                  qualidade e todo o suporte necessário.
                </p>
              </div>
              <div className="flex flex-col space-y-4">
                <div className="rounded-lg overflow-hidden shadow-lg">
                ...
                <p className="text-gray-700">
                  Apoiamos integralmente os motoristas que desejam ingressar no mundo do táxi, oferecendo não apenas
                  veículos, mas todo o suporte para que possam vislumbrar uma carreira de sucesso. Acreditamos no
                  potencial transformador desta profissão na vida das pessoas.
                </p>
              </div>
            </div>
        ...
        <section id="veiculos" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="mt-12 bg-blue-50 rounded-xl p-8 shadow-md">
              <h3 className="text-2xl font-bold mb-4 text-center">Parcerias Estratégicas</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex flex-col space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold">Parceria com DTáxi</h4>
                      <p className="text-gray-700">
                ...
                <div className="flex flex-col space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold">Localização Estratégica</h4>
                      <p className="text-gray-700">
                        Nossa frota está localizada próxima a pontos de grande movimento, facilitando o início do seu
                        dia de trabalho.
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <div className="space-y-4 bg-white p-6 rounded-xl shadow-md">
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="font-medium">contato@grupomichelines.com.br</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="rounded-xl overflow-hidden shadow-lg">
                  <iframe
                    src="https://maps.app.goo.gl/CBWQz2f3Y5msrVbb6"
                    width="100%"
                    height="300"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Empresa especializada em locação de táxis para motoristas que desejam ingressar nesta nobre profissão.
              </p>
              <p className="text-blue-400 italic font-medium">&quot;Nós alugamos carros que realizam sonhos&quot;</p>
            </div>
            <div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400">contato@grupomichelines.com.br</p>
              </div>
            </div>
            <div>
...
// Agora, vamos criar um componente de WhatsApp flutuante que aparece após o fechamento da notificação:
